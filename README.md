...
[https://yusif-mohey.github.io/Portfolio/](https://yusif-mohey.github.io/Portfolio/)

## Featured Projects

- **Request:** Order delivery platform for stores and delivery personnel.
- **Currency Detector:** Offline-first Flutter app that recognizes Egyptian banknotes using TensorFlow Lite and text-to-speech.
- **Raknaa:** Smart parking app for discovering, booking, and managing parking spots.
- **Book App:** Book discovery app with Firebase authentication and Google Books API integration.
- **Food E-Commerce App:** Food delivery application with authentication, ordering, and payment integration.
- **CaféOS:** Flutter and Laravel restaurant management system with role-based access and local-first data handling.
...
6. Wait a few minutes, then open `https://yusif-mohey.github.io/Portfolio/`.
"# Protfolio" 
